...
if (!args[0]) throw `*[❗𝐈𝐍𝐅𝐎❗], eg: ${usedPrefix + command}* https://fb.watch/fOTpgn6UFQ/` 
if (!args[0].match(/www.facebook.com|fb.watch/g)) throw `*[❗𝐈𝐍𝐅𝐎❗], EG: ${usedPrefix + command}* https://fb.watch/fOTpgn6UFQ/`
try {
await m.reply(`*[❗]...*`)      
...
conn.sendFile(m.chat, r2es, 'error.mp4', `*COOMING`, m);
} catch (err1) {
console.log('1 ' + err1)   
try {  
...
conn.sendFile(m.chat, VIDEO, 'error.mp4', `*COMMING*`, m)    
} catch (err2) {
console.log('2 ' + err2)    
try {
